...
if net:
    ...
    lcd_draw_string(draw,107,70, "XGO is offline", color=(255,255,255), scale=font2, mono_space=False)
    lcd_draw_string(draw,37,120, "please check your network settings", color=(255,255,255), scale=font2, mono_space=False)
    lcd_draw_string(draw,107,170, "Press C to exit", color=(255,255,255), scale=font2, mono_space=False)
    display.ShowImage(splash)
    while 1:
        if button.press_b():
            break
